      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg mb-12">
            Llámanos o escríbenos por WhatsApp para agendar tu cita. Atendemos de lunes a sábado.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="p-6 rounded-2xl bg-card border border-border shadow-card text-center">
              ...
              <p className="text-muted-foreground text-sm mt-1">Servicio a domicilio</p>
            </div>
            <div className="p-6 rounded-2xl bg-card border border-border shadow-card text-center">
              <Clock className="h-6 w-6 text-accent mx-auto mb-3" />
              <p className="font-semibold text-card-foreground">Horario</p>
              <p className="text-muted-foreground text-sm mt-1">Lun-Sáb: 8am - 7pm</p>
            </div>
          </div>
